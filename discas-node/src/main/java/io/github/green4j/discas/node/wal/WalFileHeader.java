...
/**
 * Fixed 64-byte WAL file header
 * <p>
 * Layout (big-endian):
 * [0..3]   magic           4 bytes  0x57414C31 ("WAL1")
 * [4..7]   formatVersion   4 bytes
 * [8..11]  headerCrc32     4 bytes  CRC of bytes [0..7]
 * [12..63] reserved        52 bytes (zeroed)
 */
final class WalFileHeader {
    static final int HEADER_SIZE = StorageFormat.WAL_HEADER_BYTES;
    public static final int MAGIC = 0x57414C31;

    private final int formatVersion;

    WalFileHeader(final int formatVersion) {
    ...
    public static WalFileHeader decode(final ByteBuffer source) {
        ...
        final int storedCrc = source.getInt();
        ...
        return new WalFileHeader(formatVersion);
    }
}
